    ...
    <div class="container-management">
        ...
        <c:forEach var="user" items="${users}" varStatus="status">
            <div class="row">
                ...
                <div class="col-md">
                    <a class="btn btn-secondary btn-management" href="${pageContext.request.contextPath}/UserManager?id=${user.id}" role="button"><fmt:message key="label.userManagement.button" /></a>
                </div>
            </div>
