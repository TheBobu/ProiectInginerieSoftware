...
public class JobPostDetails {
    ...
    public JobPostDetails(Integer id, String title, String description, int noOfPositionsAvailable, int noOfPositionsFilled, String skills, Department department, User poster, Status status) {
        this.id = id;
        this.title = title;
